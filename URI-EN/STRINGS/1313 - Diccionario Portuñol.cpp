...
// Name: Diccionario Portuñol
// Level: 8
// Category: STRINGS
// URL: https://www.urionlinejudge.com.br/judge/en/problems/view/1313
...
/*    cout << atual.c << ": ";
    ...
    for(auto &it : atual.vet)
        cout << atual.filhos[it].c << " ";
        
    cout << endl;
    
    for(auto &it : atual.vet)
        imprime(atual.filhos[it]);*/
}
